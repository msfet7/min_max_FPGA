...
module m04_couplers_imp_1W8QG7M
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m05_couplers_imp_9GBDFU
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
(* CORE_GENERATION_INFO = "mb_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mb_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=24,numReposBlks=15,numNonXlnxBlks=1,numHierBlks=9,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=37,da_board_cnt=39,da_mb_cnt=2,synth_mode=Global}" *) (* HW_HANDOFF = "mb_design.hwdef" *) 
module mb_design
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_control TRI_I" *) input [1:0]gpio_control_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_control TRI_O" *) output [1:0]gpio_control_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_control TRI_T" *) output [1:0]gpio_control_tri_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_maximum TRI_I" *) input [31:0]gpio_maximum_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_maximum TRI_O" *) output [31:0]gpio_maximum_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_maximum TRI_T" *) output [31:0]gpio_maximum_tri_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_minimum TRI_I" *) input [31:0]gpio_minimum_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_minimum TRI_O" *) output [31:0]gpio_minimum_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_minimum TRI_T" *) output [31:0]gpio_minimum_tri_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_status TRI_I" *) input [0:0]gpio_status_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_status TRI_O" *) output [0:0]gpio_status_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio_status TRI_T" *) output [0:0]gpio_status_tri_t;
  ...
  wire [1:0]axi_gpio_control_GPIO_TRI_I;
  wire [1:0]axi_gpio_control_GPIO_TRI_O;
  wire [1:0]axi_gpio_control_GPIO_TRI_T;
  wire [31:0]axi_gpio_maximum_GPIO_TRI_I;
  wire [31:0]axi_gpio_maximum_GPIO_TRI_O;
  wire [31:0]axi_gpio_maximum_GPIO_TRI_T;
  wire [31:0]axi_gpio_minimum_GPIO_TRI_I;
  wire [31:0]axi_gpio_minimum_GPIO_TRI_O;
  wire [31:0]axi_gpio_minimum_GPIO_TRI_T;
  wire [0:0]axi_gpio_status_GPIO_TRI_I;
  wire [0:0]axi_gpio_status_GPIO_TRI_O;
  wire [0:0]axi_gpio_status_GPIO_TRI_T;
  ...
  assign axi_gpio_control_GPIO_TRI_I = gpio_control_tri_i[1:0];
  assign axi_gpio_maximum_GPIO_TRI_I = gpio_maximum_tri_i[31:0];
  assign axi_gpio_minimum_GPIO_TRI_I = gpio_minimum_tri_i[31:0];
  assign axi_gpio_status_GPIO_TRI_I = gpio_status_tri_i[0];
  assign diff_clock_rtl_1_CLK_N = diff_clock_rtl_clk_n;
  assign diff_clock_rtl_1_CLK_P = diff_clock_rtl_clk_p;
  assign gpio_control_tri_o[1:0] = axi_gpio_control_GPIO_TRI_O;
  assign gpio_control_tri_t[1:0] = axi_gpio_control_GPIO_TRI_T;
  assign gpio_maximum_tri_o[31:0] = axi_gpio_maximum_GPIO_TRI_O;
  assign gpio_maximum_tri_t[31:0] = axi_gpio_maximum_GPIO_TRI_T;
  assign gpio_minimum_tri_o[31:0] = axi_gpio_minimum_GPIO_TRI_O;
  assign gpio_minimum_tri_t[31:0] = axi_gpio_minimum_GPIO_TRI_T;
  assign gpio_status_tri_o[0] = axi_gpio_status_GPIO_TRI_O;
  assign gpio_status_tri_t[0] = axi_gpio_status_GPIO_TRI_T;
  assign reset_rtl_0_1 = reset_rtl_0;
  assign reset_rtl_1 = reset_rtl;
  mb_design_axi_gpio_0_0 axi_gpio_control
       (.gpio_io_i(axi_gpio_control_GPIO_TRI_I),
        .gpio_io_o(axi_gpio_control_GPIO_TRI_O),
        .gpio_io_t(axi_gpio_control_GPIO_TRI_T),
  ...
  mb_design_axi_gpio_11_0 axi_gpio_maximum
       (.gpio_io_i(axi_gpio_maximum_GPIO_TRI_I),
        .gpio_io_o(axi_gpio_maximum_GPIO_TRI_O),
        .gpio_io_t(axi_gpio_maximum_GPIO_TRI_T),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  mb_design_axi_gpio_10_0 axi_gpio_minimum
       (.gpio_io_i(axi_gpio_minimum_GPIO_TRI_I),
        .gpio_io_o(axi_gpio_minimum_GPIO_TRI_O),
        .gpio_io_t(axi_gpio_minimum_GPIO_TRI_T),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  mb_design_axi_gpio_9_0 axi_gpio_status
       (.gpio_io_i(axi_gpio_status_GPIO_TRI_I),
        .gpio_io_o(axi_gpio_status_GPIO_TRI_O),
        .gpio_io_t(axi_gpio_status_GPIO_TRI_T),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  mb_design_minmax_ip_0_0 minmax_ip_0
  ...
  mb_design_rst_clk_wiz_1_100M_1 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module mb_design_microblaze_0_axi_periph_1
  ...
  m04_couplers_imp_1W8QG7M m04_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m05_couplers_imp_9GBDFU m05_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module microblaze_0_local_memory_imp_UIMIJC
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  mb_design_dlmb_bram_if_cntlr_1 dlmb_bram_if_cntlr
  ...
  mb_design_dlmb_v10_1 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  mb_design_ilmb_bram_if_cntlr_1 ilmb_bram_if_cntlr
